...
function userChat() {
  ...
  if (nextMessage.message.length==0){
    console.log(bot, "hsytjfshkjhtkdjbyjryryvur");
    console.log(nextMessage.message, "hsytjfshkjhtkdjbyjryryvur");
}
  ...
  /*switch (uppercase = true){
    case 'how it works':
    sendSpecialChat = [true,"Its the guardian or parent who gets the policy"];
    console.log(sendSpecialChat);
      break;
  }*/
